...
interface DeleteVariationsDialogProps {
    visible: boolean;
    onHide: () => void;
    onDeleteSelected: () => void;
}

const DeleteVariationsDialog = (props: DeleteVariationsDialogProps) => {
    ...
    return (
        ...
        >
            <div className="flex align-items-center justify-content-center">
                ...
                <span>Are you sure you want to delete the selected variations?</span>
            </div>
        </Dialog>
    );
};

export default DeleteVariationsDialog;
