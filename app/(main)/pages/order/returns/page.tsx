...
const ReturnsPage = () => {
    ...
    const loadReturnedOrders = useCallback(() => {
        setLoading(true);
        OrderApiService.getReturnedOrders(currentPage, rows, globalFilter)
    ...
    const rightToolbarTemplate = () => {
        return (
            <Button label="Refresh" icon="pi pi-refresh" className="p-button-outlined" onClick={loadReturnedOrders} />
        );
    };
    ...
    return (
        <div>
            ...
            <div className="card">
                <Toolbar className="mb-4" start={<h4 className="m-0">Returned Orders</h4>} end={rightToolbarTemplate}></Toolbar>
